...
class _pizzaState extends State<pizza> {
  final Foodwars = FirebaseFirestore.instance.collection('SmartMenupizza');
                            ...
                            return Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  AdjustText(
                                      text:
                                          'Pizza, a globally cherished dish, is a culinary masterpiece that transcends borders. With its origins in Italy, it has evolved into a diverse and universally loved comfort food. The perfect marriage of crispy crust, and an array of toppings, pizza caters to a spectrum of tastes. Whether adorned with classic pepperoni, fresh vegetables, or gourmet ingredients, it embodies a customizable delight.'),
                                  SizedBox(
                                    height: 10,
                                  ),
