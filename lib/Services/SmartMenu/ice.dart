...
class _iceState extends State<ice> {
  final Foodwars = FirebaseFirestore.instance.collection('SmartMenuIceCream');
                            ...
                            return Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  AdjustText(
                                      text:
                                          'Ice cream, a delightful frozen treat, brings joy with its creamy texture and diverse flavors. Whether enjoyed in a cone, cup, or sandwiched between cookies, its a universal indulgence loved by all ages. From classic vanilla to exotic creations, ice cream offers a sweet escape and a moment of pure pleasure.Its versatility allows for endless combinations of ingredients, making it a canvas for culinary creativity. '),
                                  SizedBox(
                                    height: 10,
                                  ),
