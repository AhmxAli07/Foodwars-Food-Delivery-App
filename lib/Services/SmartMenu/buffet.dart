...
class bufet extends StatefulWidget {
  const bufet({super.key});

  @override
  State<bufet> createState() => _bufetState();
}

class _bufetState extends State<bufet> {
  final Foodwars = FirebaseFirestore.instance.collection('SmartMenubuf');
                            ...
                            return Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  AdjustText(
                                      text:
                                          ' Grilled or skewered and cooked to perfection, Buffet offer a satisfying combination of smoky char and juicy tenderness. Often marinated in a mixture of herbs, garlic, and spices, this dish showcases the rich and hearty flavors of beef. Whether enjoyed on its own or wrapped in flatbread with accompaniments like yogurt sauce and fresh vegetables.'),
                                  SizedBox(
                                    height: 10,
                                  ),
