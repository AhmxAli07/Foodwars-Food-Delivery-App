...
class _BreadState extends State<Bread> {
  final Foodwars = FirebaseFirestore.instance.collection('HealthyMenubread');
                            ...
                            return Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  AdjustText(
                                      text:
                                          'Bread, a culinary cornerstone, transcends cultures with its simple yet essential presence. Crafted from flour, water, yeast, and salt, it undergoes a magical transformation through fermentation and baking. This versatile staple comes in countless forms, from crusty artisanal loaves to soft sandwich slices. Beyond sustenance, bread embodies tradition, symbolizing the heart of meals and fostering communal connections.'),
                                  SizedBox(
                                    height: 10,
                                  ),
