...
class _fishState extends State<fish> {
  final Foodwars = FirebaseFirestore.instance.collection('HealthyMenufish');
                            ...
                            return Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  AdjustText(
                                      text:
                                          'Fish, the ocean bounty, offers a delectable array of flavors and textures. Packed with omega-3 fatty acids and lean protein, fish promotes heart health and overall well-being. Whether grilled, baked, or pan-seared, its  A symbol of coastal cuisines, fish savory allure extends a global invitation to savor the treasures of the sea in every succulent bite.'),
                                  SizedBox(
                                    height: 10,
                                  ),
