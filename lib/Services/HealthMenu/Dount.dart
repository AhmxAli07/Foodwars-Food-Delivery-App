...
class _DountState extends State<Dount> {
  final Foodwars = FirebaseFirestore.instance.collection('HealthyMenuDou');
                            ...
                            return Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  AdjustText(
                                      text:
                                          'These delightful pastries come in a myriad of flavors and toppings, from classic glazed and powdered sugar to more adventurous choices like maple bacon or fruit-filled varieties. With their soft, airy texture and sugary coating, doughnuts are a tempting indulgence enjoyed at breakfast or as a delightful snack.'),
                                  SizedBox(
                                    height: 10,
                                  ),
