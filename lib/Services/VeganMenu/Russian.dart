...
class _russianState extends State<russian> {
  final Foodwars = FirebaseFirestore.instance.collection('VeganMenuRus');
                            ...
                            return Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  AdjustText(
                                      text:
                                          'The versatility of Russian salad allows for creative variations, with some recipes incorporating proteins like chicken or ham. Whether served as a side dish or a refreshing main course, this salad is a celebration of freshness and balance.Embrace the culinary charm of Russian salad, where simplicity meets sophistication in a bowl of vibrant and delicious harmony.'),
                                  SizedBox(
                                    height: 10,
                                  ),
