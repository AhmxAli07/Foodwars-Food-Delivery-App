...
class _pieState extends State<pie> {
  final Foodwars = FirebaseFirestore.instance.collection('VeganMenuPie');
                            ...
                            return Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  AdjustText(
                                    text:
                                        'Our vegan pie collection is a celebration of plant-based goodness, offering a rich array of flavors and textures that rival traditional counterparts. From luscious fruit-filled delights to creamy, each pie is meticulously crafted with plant-based ingredients to create a satisfying experience for every palate. Discover the artistry of vegan baking as we redefine classic favorites, ensuring that every slice is a guilt-free pleasure.',
                                  ),
                                  SizedBox(
                                    height: 5,
                                  ),
