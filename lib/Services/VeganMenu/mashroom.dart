...
class mashroom extends StatefulWidget {
  const mashroom({super.key});

  @override
  State<mashroom> createState() => _mashroomState();
}

class _mashroomState extends State<mashroom> {
  final Foodwars = FirebaseFirestore.instance.collection('VeganMenuMashroom');
                            ...
                            return Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  AdjustText(
                                    text:
                                        'Renowned for its rich umami flavor and unique texture, mushrooms add depth and character to a variety of dishes. From the delicate enoki to the robust portobello, these fungi offer a spectrum of tastes to suit every palate. Whether sautéed, grilled, or incorporated into hearty stews, mushrooms bring a savory dimension to your plate. ',
                                  ),
                                  SizedBox(
                                    height: 15,
                                  ),
