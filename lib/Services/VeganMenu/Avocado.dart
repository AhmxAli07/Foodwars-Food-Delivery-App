...
class _AvocadoState extends State<Avocado> {
  final Foodwars = FirebaseFirestore.instance.collection('VeganMenuA');
                            ...
                            return Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  AdjustText(
                                      text:
                                          'Elevating the salad further is often a zesty dressing, which can range from a simple drizzle of olive oil and lime juice to more elaborate options featuring herbs and spices. Avocado salad is not only a feast for the taste buds but also a nutritional powerhouse, as avocados are packed with healthy fats, vitamins, and minerals.'),
                                  SizedBox(
                                    height: 10,
                                  ),
